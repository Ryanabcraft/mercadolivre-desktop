#!/usr/bin/env python3
"""Mercado Livre Desktop — abre Mercado Livre no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/mercadolivre-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Mercado Livre Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("Mercado Livre Desktop", msg)
        sys.exit(1)
